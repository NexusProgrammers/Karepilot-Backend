...
export const getAllMobileUsers = async (req: Request, res: Response): Promise<void> => {
  try {
    const query = {
...
export const getMobileUserById = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
    const mobileUser = await mobileUserService.getMobileUserById(id as string);
...
export const updateMobileUserStatus = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
    const { status } = req.body;

    const mobileUser = await mobileUserService.updateMobileUserStatus(
      id as string,
      status as string,
    );
